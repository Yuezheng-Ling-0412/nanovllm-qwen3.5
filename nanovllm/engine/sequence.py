...
class Sequence:
    ...
    def __init__(self, token_ids: list[int], sampling_params = SamplingParams()):
        ...
        self.block_table = []
        self.state_slot_id = -1       # GDN state slot (-1 = not allocated) extra
        self.temperature = sampling_params.temperature
        self.max_tokens = sampling_params.max_tokens
        self.ignore_eos = sampling_params.ignore_eos
        # Multimodal data (consumed on first prefill, then cleared) extra
    ...
    def __getstate__(self):
        ...
        return (
            ...
            self.block_table,
            self.state_slot_id, # extra
            last_state, # extra
            self.temperature,   # extra
        )
